...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60192b792b490f0015be7412
...
To start editing your site, you can use the Sanity interface at https://conversations-with-rushmoor-92b79.sanity.studio/.
...
Generated at `2021-02-02T10:39:57.193Z` by Stackbit version `0.3.44`.